...
<section id="demo" className="py-20 bg-gradient-to-b from-primary-50/30 to-white">
  <div className="container mx-auto px-4 md:px-6">
    ...
    <div className="relative max-w-5xl mx-auto">
      ...
      {/* Relative container for the card and external buttons */}
      <div className="relative">
        ...
        <button 
          onClick={prevSlide}
          className="absolute top-1/2 left-[-2rem] transform -translate-y-1/2 w-10 h-10 rounded-full border border-primary-200 flex items-center justify-center text-primary-600 hover:bg-primary-50 transition-colors"
        ...
        <button 
          onClick={nextSlide}
          className="absolute top-1/2 right-[-2rem] transform -translate-y-1/2 w-10 h-10 rounded-full border border-primary-200 flex items-center justify-center text-primary-600 hover:bg-primary-50 transition-colors"
